...
import {type AuthContextUser, SupabaseAuthGuard} from "../../auth/supabase-auth.guard";
...
export class VehicleResolver {
  ...
  async vehiclesModelsByMake(@CurrentUser() current?: AuthContextUser, @Args('makeId', { type: () => Int }) makeId?: number) {
  ...
  async vehiclesMakesByType(@CurrentUser() current?: AuthContextUser, @Args('typeId', { type: () => Int }) typeId?: number) {
